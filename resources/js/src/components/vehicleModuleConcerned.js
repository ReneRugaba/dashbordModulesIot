            ...
            <div className='containerVehicle'>
                <div className='containerVehicleInfos'>
                    ...
                    <div className='mt-6 pt-5'>
                        <h1 className='font-bold'>Vehicle type: <span className='text-blue-700'>{vehicleType.vehicle_type}</span></h1>
                        <h1 className='font-bold'>Vehicle capacity: <span className='text-blue-700'>{vehicleType.passenger_max} </span>prs/max</h1>
                        <h1 className='font-bold'>Vehicle matricule: <span className='text-blue-700'>{vehicleDatails.vehicle.registration_nb}</span></h1>
                        <h1 className='font-bold'>Vehicle release: <span className='text-blue-700'>{GetIntervaleDate(vehicleDatails.vehicle.release)}</span></h1>
                    </div>
